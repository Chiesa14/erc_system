...
const feedbackData = [
  {
    ...
    content: "Our family had an amazing time at the youth camp. The activities were well-organized and our teens learned so much. Thank you for the excellent leadership!",
    rating: 5,
  ...
  },
  {
    ...
    content: "We've noticed some scheduling conflicts with the Bible study sessions and school activities. Could we possibly look into alternative time slots?",
    rating: 3,
    ...
    replies: [
      {
        ...
        content: "Thank you for bringing this to our attention. We'll discuss this at our next planning meeting and get back to you with some options.",
  ...
  },
  {
    ...
    content: "We're having difficulty with transportation to some of the community service events. Are there any carpooling options available?",
    rating: null,
    ...
    replies: [
      {
        id: 1,
        author: "Sarah Johnson (Youth Leader)",
        content: "We've organized a carpool group for community service events. I'll send you the contact information.",
...
const getCategoryColor = (category: string) => {
  switch (category) {
    case "praise": return "bg-green-500/10 text-green-700 border-green-200";
    case "suggestion": return "bg-blue-500/10 text-blue-700 border-blue-200";
    case "question": return "bg-purple-500/10 text-purple-700 border-purple-200";
    case "concern": return "bg-orange-500/10 text-orange-700 border-orange-200";
    default: return "bg-gray-500/10 text-gray-700 border-gray-200";
  }
};
    ...
    <div className="space-y-8 p-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        <div>
          ...
          <p className="text-muted-foreground">Review and respond to feedback from families</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <Badge className="bg-blue-500/10 text-blue-700">{newFeedbackCount}</Badge>
          </div>
      ...
      <div className="space-y-4">
        {filteredFeedback.map((feedback) => (
          <Card key={feedback.id} className={feedback.status === "new" ? "border-blue-200 bg-blue-50/30" : ""}>
            <CardHeader>
