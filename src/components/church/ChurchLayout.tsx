  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen-safe flex w-full bg-background overflow-hidden touch-pan-y">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Avatar className="h-8 w-8 xs:h-9 xs:w-9 md:h-10 md:w-10 touch:h-11 touch:w-11 cursor-pointer hover:opacity-90 transition-opacity">
                      <AvatarImage src={profilePhotoUrl} alt={user?.full_name || "Pastor"} className="object-cover" />
        ...
        {/* Enhanced Mobile-First Pastor Profile Dialog */}
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  className="w-full touch:h-12"
                  placeholder="Share your ministry experience..."
                />
